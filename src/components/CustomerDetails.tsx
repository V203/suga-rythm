...
const CustomerDetails = (props: any) => {
    ...
    return (
        <>
            <Button variant={'outline'} onClick={onOpen}>Pay {props.total}</Button>
            ...
            <Modal isOpen={isOpen} onClose={onClose} size={"lg"}>
                ...
                <ModalContent >
                    ...
                    <ModalBody >
                        <Stack>
                            ...
                            <InputGroup size={"xs"}>
                                ...
                                <Input onChange={handleChange} value={customerDetails.name} name={"name"} size={"xs"} type={"text"} placeholder={"Steve"} isRequired />
                            </InputGroup>

                            <InputGroup size={"xs"}>
                                <InputLeftAddon w={"7em"} children={"Surname"} />
                                <Input onChange={handleChange} value={customerDetails.surname} name={"surname"} type={"text"} placeholder={"Rodgers"} />
                            </InputGroup>
                    ...
                    <ModalFooter color={"White"} bgGradient={"linear(to-b,brown,#E85298,#FF0080,brown)"}>
                        ...
                        <Button  onClick={handleSubmit} size={"xs"} variant={"outline"} colorScheme='black'>
                            Confirm
                        </Button>
                    </ModalFooter>
                </ModalContent>
